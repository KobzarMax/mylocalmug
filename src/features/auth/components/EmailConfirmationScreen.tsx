        ...
        <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
          ...
          <View style={styles.card}>
            ...
            <Text style={styles.hint}>
              Enter the newest numeric code from the email. If your template also includes a confirmation
              link, the app can process that too.
            </Text>
            {props.error && (
            ...
            <Pressable
              ...
              style={[styles.secondary, resendDisabled && styles.disabled]}
            >
              <Text style={styles.secondaryText}>
                {props.cooldown > 0 ? `Resend available in ${props.cooldown}s` : 'Resend confirmation email'}
              </Text>
            </Pressable>
            <Pressable
              accessibilityRole="button"
